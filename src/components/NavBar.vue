            ...
            <div class="dropdown-menu" role="menu">
              ...
              <div class="dropdown dropdown-submenu">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="pricing-charts-2.html">Comparison charts</a>
                  <a class="dropdown-item" href="pricing.html">Package plans</a>
                </div>
              </div>
            ...
            <div class="dropdown-menu" role="menu">
              <div class="dropdown dropdown-submenu">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="header-off-canvas-collapse.html">Off-canvas collapse</a>
            ...
            <div class="dropdown-menu dropdown-extend-menu" role="menu">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <a class="dropdown-item" href="docs/datepicker.html"><i class="ion-calendar"></i> Datepicker</a>
                </div>
              </div>
            </div>
          </li>
